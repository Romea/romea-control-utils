...
#ifndef ROMEA_FOLLOWING_UTILS__COMMAND_FACTORY_HPP_
#define ROMEA_FOLLOWING_UTILS__COMMAND_FACTORY_HPP_
...
void get_params(
  ...
  core::FollowMe::Parameters & parameters)
{
...
void get_params(
  std::shared_ptr<Node> node, const std::string & params_ns,
  core::FollowTrajectoryClassicSliding::Parameters & parameters)
{
...
void get_params(
  std::shared_ptr<Node> node, const std::string & params_ns,
  core::FollowTrajectoryPredictiveSliding::Parameters & parameters)
{
  parameters.front_kp = get_parameter<double>(node, params_ns, "gains.front_kp");
  parameters.rear_kp = get_parameter<double>(node, params_ns, "gains.rear_kp");
  parameters.horizon = get_parameter<int>(node, params_ns, "prediction.horizon");
